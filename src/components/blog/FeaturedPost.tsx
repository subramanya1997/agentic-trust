...
export const FeaturedPost = ({ date, readTime, title, description, author, category }: FeaturedPostProps) => {
  return (
    <div className="relative mb-16 group cursor-pointer">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-r from-orange-100 via-pink-50 to-purple-100 rounded-2xl opacity-60 group-hover:opacity-80 transition-opacity duration-300" />
      ...
      <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/50">
        <div className="grid lg:grid-cols-5 gap-0">
          ...
          <div className="lg:col-span-3 p-8 md:p-12 lg:p-16">
            ...
            {/* Title */}
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 leading-tight group-hover:text-orange-600 transition-colors duration-300">
              {title}
            </h1>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="w-12 h-12 bg-gradient-to-br from-orange-400 to-pink-500 rounded-full flex items-center justify-center text-white font-bold shadow-lg">
                    {author.avatar}
                  </div>
              ...
              <button className="flex items-center gap-2 text-orange-600 font-semibold hover:text-orange-700 transition-colors group/btn">
          ...
          <div className="lg:col-span-2 relative h-64 lg:h-auto bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-8 overflow-hidden">
            ...
            <div className="relative grid grid-cols-2 gap-4 max-w-xs">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow group/icon">
                <svg className="w-10 h-10 text-orange-500 group-hover/icon:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
              ...
              {/* Network Icon */}
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow group/icon">
                <svg className="w-10 h-10 text-purple-500 group-hover/icon:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <path d="M4 7h16"/>
                  <path d="M4 17h16"/>
                  <path d="M8 12h8"/>
              ...
              {/* Security Icon */}
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow group/icon">
                <svg className="w-10 h-10 text-green-500 group-hover/icon:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
              ...
              {/* Analytics Icon */}
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow group/icon">
                <svg className="w-10 h-10 text-blue-500 group-hover/icon:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <path d="M3 3v18h18"/>
